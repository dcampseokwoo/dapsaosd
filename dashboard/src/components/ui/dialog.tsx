// ABOUTME: shadcn/ui Dialog — 레코드 상세 보기 모달 (Radix Dialog 기반)
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-3xl border bg-background p-6 shadow-lg duration-200",
          className
        )}
        {...props}
      >
